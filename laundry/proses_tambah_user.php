...
if($_POST){
    ...
    if(empty($nama_user)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into user (nama_user, username, password, role, alamat, id_user) value ('".$nama_user."','".$username."','".md5($password)."','".$role."','".$alamat."','".$id_user."')") or die(mysqli_error($conn));
        if($insert){
